 ...
 * Features dynamic greeting ("Good Evening, Akhil"), search, quick upload button,
 * notification bell with badge, and user avatar profile link.
 */
const TopNavbar = () => {
    ...
    <header className="glass-nav sticky top-0 z-40 w-full border-b border-border/80 px-4 py-3 sm:px-6 lg:px-8 backdrop-blur-xl">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center justify-between gap-3 sm:justify-end">
          {/* Quick Search Input */}
          <div className="relative flex-1 max-w-xs sm:w-64 md:w-72">
            ...
            <input
              ...
              className="w-full rounded-xl border border-glass-border bg-surface/60 py-2 pl-9 pr-12 text-xs text-white placeholder-text-muted outline-none transition-all duration-200 focus:border-primary focus:bg-surface focus:ring-1 focus:ring-primary sm:text-sm"
            />
            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2.5">
              <kbd className="hidden rounded border border-border/40 bg-surface-light/40 px-1.5 py-0.5 text-[10px] font-medium text-text-secondary md:inline-block">
                ⌘K
              </kbd>
            </div>
          </div>
