    ...
    <div className="space-y-1.5 font-sans">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            'w-full rounded-xl border bg-[#121A2F] py-3 pl-11 pr-12 text-sm text-white placeholder-[#64748B] transition-all',
        ...
        <button
          ...
          className="absolute inset-y-0 right-0 flex items-center pr-3.5 text-[#A1A8B5] hover:text-white transition-colors cursor-pointer"
